...
The theme includes the [DM Sans](https://fonts.google.com/specimen/DM+Sans) font family, exposed as a `font-sl-dm-sans` utility (the prefix follows your `prefix` option in v3). The font files ship with this package via [`@fontsource/dm-sans`](https://fontsource.org/fonts/dm-sans) (weights 400, 500, 700) — no Google Fonts request, no separate install.
